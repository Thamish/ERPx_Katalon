...
WebUI.callTestCase(findTestCase('Login/Positive/Successful login'), [('UserName') : findTestData('LoginDataCorrect').getValue(
            1, 1), ('Client') : findTestData('LoginDataCorrect').getValue(2, 1), ('Password') : findTestData('LoginDataCorrect').getValue(
